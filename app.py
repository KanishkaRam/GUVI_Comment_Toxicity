...
with col1: st.metric("Language", "Python")
with col2: st.metric("Framework", "TensorFlow")
with col3: st.metric("UI", "Streamlit")
...
st.markdown("---")
st.caption("Comment Toxicity Detection using NLP & BiLSTM | Developed with Python, TensorFlow, and Streamlit")
st.markdown("---")
st.success("✅ Model Loaded Successfully")
st.info("Use the pages in the sidebar to predict comments, upload CSV files, and explore model performance.")